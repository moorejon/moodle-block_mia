...
* Rename the mia/ folder to the name of your module (eg "widget").
...
all the instances of the string "mia" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/mia/widget/g' {} \;

* Rename the file lang/en/mia.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_mia.php
...
and you should find that this mia has been added to the list of
installed modules.
